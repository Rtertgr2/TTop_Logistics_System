...
# Data retention (days) for customer orders & location memory.
...
# Data Protection Officer contact (for DSAR / breach notifications).
DPO_CONTACT_EMAIL = os.getenv("DPO_CONTACT_EMAIL", "")
