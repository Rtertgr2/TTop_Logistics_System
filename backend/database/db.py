"""
Backward-compatible shim — all functions moved to submodules under database/.
Import from database.* or database.connection / database.order_db / etc. directly.
"""

from database.connection import (
    engine, SessionLocal, get_db, check_db_connection, get_db_status,
    init_db, _business_today, _record_db_metric,
)
...
from database.delivery_db import (
    ...
    update_item_delivery, reschedule_stop, auto_arrive_stop,
)
...
from database.user_db import (
    create_employee, update_employee, change_employee_password,
    toggle_employee_active, get_employee, list_employees, get_audit_logs,
    log_audit, count_admins,
)
